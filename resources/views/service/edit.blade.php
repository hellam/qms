                ...
                <div class="row">
                    <div class="col s12 m12 l12">
                        ...
                        <ol class="breadcrumbs col s7 right-align">
                            <a class="btn-floating waves-effect waves-light teal tooltipped"
                               href="{{route('services.index')}}" data-position=top
                               data-tooltip="{{__('messages.common.go back')}}"><i class="material-icons">arrow_back</i></a>
                        </ol>
                    </div>
                </div>
            </div>
                                    ...
                                    <div class="row">
                                        <div class="row form_align">
                                            ...
                                            <div class="input-field col s6">
                                                ...
                                                <input id="ar_name" name="ar_name" type="text"
                                                       value="{{$service->ar_name}}" data-error=".ar_name">
                                                <div class="ar_name">
                                        ...
                                        <div class="row form_align">
                                            <div class="input-field col s6">
                                                ...
                                                <input id="letter" name="letter" type="text"
                                                       value="{{$service->letter}}" data-error=".letter">
                                                <div class="letter">
                                            ...
                                            <div class="input-field col s6">
                                                ...
                                                <input id="start_number" name="start_number" type="number"
                                                       value="{{$service->start_number}}" data-error=".start_number">
                                        ...
                                        <div class="row form_align">
                                            <div class="input-field col s3">
                                                <select name="ask_name" id="ask_name" data-error=".ask_name"
                                                        onchange="enableRequired()">
                                                    <option value="0" @if($service->ask_name==0) selected @endif>No
                                                    </option>
                                                    <option value="1" @if($service->ask_name==1) selected @endif>Yes
                                                    </option>
                                                </select>
                                            ...
                                            <div class="input-field col s3">
                                                <select name="name_required" id="name_required"
                                                        data-error=".name_required">
                                                    <option value="0" @if($service->name_required==0) selected @endif>
                                                        No
                                                    </option>
                                                    <option value="1" @if($service->name_required==1) selected @endif>
                                                        Yes
                                                    </option>
                                                </select>
                                            ...
                                            <div class="input-field col s3">
                                                <select name="ask_email" id="ask_email" data-error=".ask_email"
                                                        onchange="enableRequired()">
                                                    <option value="0" @if($service->ask_email==0) selected @endif>No
                                                    </option>
                                                    <option value="1" @if($service->ask_email==1) selected @endif>Yes
                                                    </option>
                                                </select>
                                            ...
                                            <div class="input-field col s3">
                                                <select name="email_required" id="email_required"
                                                        data-error=".email_required">
                                                    <option value="0" @if($service->email_required==0) selected @endif>
                                                        No
                                                    </option>
                                                    <option value="1" @if($service->email_required==1) selected @endif>
                                                        Yes
                                                    </option>
                                                </select>
                                        ...
                                        <div class="row form_align">
                                            <div class="input-field col s3">
                                                <select name="ask_phone" id="ask_phone" data-error=".ask_phone"
                                                        onchange="enableRequired()">
                                                    <option value="0" @if($service->ask_phone==0) selected @endif>No
                                                    </option>
                                                    <option value="1" @if($service->ask_phone==1) selected @endif>Yes
                                                    </option>
                                                </select>
                                            ...
                                            <div class="input-field col s3">
                                                <select name="phone_required" id="phone_required"
                                                    ...
                                                    <option value="0" @if($service->phone_required==0) selected @endif>
                                                        No
                                                    </option>
                                                    <option value="1" @if($service->phone_required==1) selected @endif>
                                                        Yes
                                                    </option>
                                                </select>
                                            ...
                                            @if($settings->sms_enabled)
                                                <div class="input-field col s6">
                                                    <select name="sms" id="sms" data-error=".sms"
                                                            onchange="changeSMS()">
                                                        <option value="0" @if($service->sms_enabled==0) selected @endif>
                                                            No
                                                        </option>
                                                        <option value="1" @if($service->sms_enabled==1) selected @endif>
                                                            Yes
                                                        </option>
                                                    </select>
                                        ...
                                        @if($settings->sms_enabled)
                                            <div id="sms_tab">
                                                ...
                                                <div class="row form_align">
                                                    <div class="input-field col s6">
                                                        <select name="optin_message" id="optin_message"
                                                                data-error=".optin_message"
                                                                onchange="changeOptinMessage()">
                                                            <option value="0"
                                                                    @if($service->optin_message_enabled== 0) selected @endif>
                                                                No
                                                            </option>
                                                            <option value="1"
                                                                    @if($service->optin_message_enabled== 1) selected @endif>
                                                                Yes
                                                            </option>
                                                        </select>
                                                    ...
                                                    <div class="input-field col s6">
                                                        <select name="call_message" id="call_message"
                                                                data-error=".call_message"
                                                                onchange="changeCallMessage()">
                                                            <option value="0"
                                                                    @if($service->call_message_enabled== 0) selected @endif>
                                                                No
                                                            </option>
                                                            <option value="1"
                                                                    @if($service->call_message_enabled== 1) selected @endif>
                                                                Yes
                                                            </option>
                                                        </select>
                                                ...
                                                <div class="row form_align">
                                                    <div class="input-field col s6" style="margin-top: 0;"
                                                         id="optin_message_tab">
                                                        <textarea id="optin_message_format" name="optin_message_format"
                                                                  class="materialize-textarea"
                                                                  data-error=".optin_message_format">@if($service->optin_message_format)
                                                                {{$service->optin_message_format}}
                                                            @else
                                                                Welcome, your token number is `$token_number$`. You are
                                                                position $position$ in the `$service_name$` queue
                                                            @endif</textarea>
                                                    ...
                                                    <div class="input-field col s6" style="margin-top: 0; float: right;"
                                                         id="call_message_tab">
                                                        <textarea id="call_message_format" name="call_message_format"
                                                                  class="materialize-textarea"
                                                                  data-error=".call_message_format">@if($service->call_message_format)
                                                                {{$service->call_message_format}}
                                                            @else
                                                                Your token number '$token_number$' is next to see to
                                                                '$service_name$' queue
                                                            @endif</textarea>
                                                ...
                                                <div class="row form_align">
                                                    <div class="input-field col s6">
                                                        <select name="noshow_message" id="noshow_message"
                                                                data-error=".noshow_message"
                                                                onchange="changeNoshowMessage()">
                                                            <option value="0"
                                                                    @if($service->noshow_message_enabled== 0) selected @endif>
                                                                No
                                                            </option>
                                                            <option value="1"
                                                                    @if($service->noshow_message_enabled== 1) selected @endif>
                                                                Yes
                                                            </option>
                                                        </select>
                                                    ...
                                                    <div class="input-field col s6">
                                                        <select name="completed_message" id="completed_message"
                                                                data-error=".completed_message"
                                                                onchange="changeCompletedMessage()">
                                                            <option value="0"
                                                                    @if($service->completed_message_enabled== 0) selected @endif>
                                                                No
                                                            </option>
                                                            <option value="1"
                                                                    @if($service->completed_message_enabled== 1) selected @endif>
                                                                Yes
                                                            </option>
                                                        </select>
                                                ...
                                                <div class="row form_align">
                                                    <div class="input-field col s6" style="margin-top: 0;"
                                                         id="noshow_message_tab">
                                                        <textarea id="noshow_message_format"
                                                                  name="noshow_message_format"
                                                                  class="materialize-textarea"
                                                                  data-error=".noshow_message_format">{{$service->noshow_message_format ? $service->noshow_message_format : 'Your token number `$token_number$` is marked as no show'}}</textarea>
                                                        <label for="noshow_message_format">No Show Message
                                                            Format</label>
                                                    ...
                                                    <div class="input-field col s6" style="margin-top: 0;float: right;"
                                                         id="completed_message_tab">
                                                        <textarea id="completed_message_format"
                                                                  name="completed_message_format"
                                                                  class="materialize-textarea"
                                                                  data-error=".completed_message_format">{{$service->completed_message_format ? $service->completed_message_format : 'Thank you for using our service, Have a good day'}}</textarea>
                                                    ...
                                                    <div class="row form_align">
                                                        <div class="input-field col s6">
                                                            <select name="status_message" id="status_message"
                                                                    ...
                                                                    onchange="changeStatusMessage()">
                                                                <option value="0"
                                                                        @if($service->status_message_enabled== 0) selected @endif>
                                                                    No
                                                                </option>
                                                                <option value="1"
                                                                        @if($service->status_message_enabled== 1) selected @endif>
                                                                    Yes
                                                                </option>
                                                            </select>
                                                    ...
                                                    <div id="status_message_tab">
                                                        <div class="row form_align">
                                                            <div class="input-field col s6">
                                                                <select name="status_message_positions[]"
                                                                        id="status_message_positions"
                                                                        data-error=".status_message_positions" multiple>

                                                                    <option value="3"
                                                                            @if(($service->status_message_positions && in_array('3',$service->status_message_positions)) || !$service->status_message_positions) selected @endif>
                                                                        3
                                                                    </option>
                                                                    <option value="5"
                                                                            @if($service->status_message_positions && in_array('5',$service->status_message_positions)) selected @endif>
                                                                        5
                                                                    </option>
                                                                    <option value="10"
                                                                            @if($service->status_message_positions && in_array('10',$service->status_message_positions)) selected @endif>
                                                                        10
                                                                    </option>
                                                                    <option value="15"
                                                                            @if($service->status_message_positions && in_array('15',$service->status_message_positions)) selected @endif>
                                                                        15
                                                                    </option>
                                                                    <option value="20"
                                                                            @if($service->status_message_positions && in_array('20',$service->status_message_positions)) selected @endif>
                                                                        20
                                                                    </option>
                                                                </select>
                                                        ...
                                                        <div class="row form_align">
                                                            <div class="input-field col s6" style="margin-top: 0;">
                                                                <textarea id="status_message_format"
                                                                          name="status_message_format"
                                                                          class="materialize-textarea"
                                                                          data-error=".status_message_format">{{$service->status_message_format ? $service->status_message_format : ' Your token number `$token_number$` is at position $position$ in the `$service_name$` queue'}}</textarea>
                                        ...
                                        <div class="input-field col s12">
                                            <button class="btn waves-effect waves-light right submit" type="submit"
                                                    name="action">{{__('messages.common.update')}}

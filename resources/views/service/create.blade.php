                                    ...
                                    <div id="sms_tab">
                                        ...
                                        <div class="row form_align">
                                            <div class="input-field col s6" style="margin-top: 0;" id="optin_message_tab">
                                                <textarea id="optin_message_format" name="optin_message_format" class="materialize-textarea" data-error=".optin_message_format">Welcome, your token number is `$token_number$`. You are position $position$ in the `$service_name$` queue</textarea>
                                        ...
                                        <div id="status_message_tab">
                                            ...
                                            <div class="row form_align">
                                                <div class="input-field col s6" style="margin-top: 0;">
                                                    <textarea id="status_message_format" name="status_message_format" class="materialize-textarea" data-error=".status_message_format">Your token number `$token_number$` is at position $position$ in the `$service_name$` queue </textarea>

...
<head>
    ...
    <title>ADMIN LOGIN | SHIVA QMS</title>
...
<body class="vertical-layout page-header-light vertical-menu-collapsible vertical-dark-menu preload-transitions 1-column    blank-page blank-page" data-open="click" data-menu="vertical-dark-menu" data-col="1-column" style="background-color: #016B3F;">
    <div class="row">
        <div class="col s12">
            <div class="container">
                        ...
                        <form id="login_form" class="login-form" method="post" action="{{route('post_login')}}">
                            ...
                            <div class="row">
                                <div class="input-field col s12 offset-m4">
                                    <h5 class="ml-4" style="font-weight: 800;">SHIVA QMS</h5>
                                </div>
                            </div>

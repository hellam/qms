            ...
            <div class="nav-wrapper">
                ...
                <ul class="navbar-list right">
                    ...
                    @if( Auth::user()->can('view issue token') || Auth::user()->can('view display'))
                        <li class="navbar-list left"><a class="waves-effect waves-block waves-light profile-button"
                                                        href="javascript:void(0);" data-target="extra-dropdown"><i
                                        class="material-icons">attachment</i></a></li>
                    @endif
                    <li class="navbar-list left"><a href="{{route('profile')}}"><b>{{session()->get("settings")->name}}
                                ,{{session()->get("settings")->location}}</b></a></li>
                    ...
                    <li><a class="waves-effect waves-block waves-light profile-button" href="javascript:void(0);"
                           data-target="profile-dropdown"><span class="avatar-status ">
                ...
                <ul class="dropdown-content" id="profile-dropdown">
                    @can('view profile')
                        <li><a class="grey-text text-darken-1" href="{{route('profile')}}" ontouchstart="viewProfile()"><i
                                        class="material-icons">person_outline</i> {{__('messages.common.profile')}}</a>
                        </li>
                        <li class="divider"></li>
                    @endcan
                    <li><a class="grey-text text-darken-1" href="{{route('logout')}}" ontouchstart="logout()"><i
                                    class="material-icons">keyboard_tab</i> {{__('messages.common.logout')}}</a></li>
                </ul>
...
<footer class="page-footer footer footer-static navbar-border navbar-shadow">
    <div class="footer-copyright">
        <div class="container">
            <span>Powered by&nbsp;<a href="javascript:void(0)"
                                     style="color:#ffffff;font-weight: bolder;">SHIVA.CO.KE</a>&nbsp;All rights reserved</span>
            @if(\App::currentLocale() == 'sa')

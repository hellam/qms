                        ...
                        <div class="collection border-none mt-0 mb-0">
                            ...
                            <ul class="collection right-sidebar-chat p-0 m-0" v-if="!loader">
                                <li class="right-sidebar-chat-item pb-0 waves-effect waves-light next-to-call"
                                    ...
                                    style="padding:0px; align-items:center; min-height:40px" @click="showNextToCall()">
                                    ...
                                    <div class="user-content"
                                        ...
                                        <div @click="!isCalled ? callNext(token.id): ''"
                                             ...
                                             :class="{'recall-active':  !isCalled, 'disabled-color': isCalled }"><i
                                                    class="material-icons" style="font-size: 22px; color:#fff">call</i>
                                        </div>
                                ...
                                <li class="right-sidebar-chat-item  pb-0 waves-effect waves-light next-to-call"
                                    ...
                                    style="padding:0px; align-items:center; min-height:40px" @click="showCalled()">
                                    <div class="user-content"
                                         style="width: 100%; display: flex; justify-content: space-between; align-items: center;">
                                ...
                                <li class="right-sidebar-chat-item  pb-0"
                                    style="padding:0px; align-items:center; min-height:40px; cursor:auto"
                                    data-target="slide-out-chat" v-for=" token in called_tokens" v-if="show_called">
                                    <div class="user-content"
                                         style="width: 100%; display: flex; justify-content: space-between; align-items: center; margin-bottom: .1rem; margin-top: .7em;">
                                        <div @click="(token.call_status_id == {{CallStatuses::NOSHOW}} && !isCalled) ? recallToken(token.id) : ''"
                                             style="border-radius:50%; display:flex; align-items:center; padding:5px;"
                                             :class="{'recall-active': token.call_status_id == {{CallStatuses::NOSHOW}} && !isCalled, 'disabled-color': token.call_status_id != {{CallStatuses::NOSHOW}} || isCalled }">
                                            <i class="material-icons" style="font-size: 22px; color:#fff">replay</i>
                                        </div>
                                        <h6 style="margin: 0px; font-size:20px; font-weight:600;">
...
@if((Route::current()->getName() == 'issue_token' || Route::current()->getName() == 'display') && \App::currentLocale() == 'sa')
    <footer class="page-footer footer footer-static navbar-border navbar-shadow noprint" style="padding-right: 10px">
        <div class="footer-copyright">
            <div class="container">
                <span>Powered by&nbsp;<a href="javascript:void(0)" style="color:#ffffff;font-weight: bolder;">SHIVA.CO.KE</a>&nbsp;All rights reserved</span>
